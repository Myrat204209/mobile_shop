...
import 'package:mobile_shop/core/location/location_service_2.dart';
...
Future<void> bootStrap(Talker talker, AppBuilder builder) async {
  await runTalkerZonedGuarded<Future<void>>(
    ...
    () async {
      ...
      // final geoInitResult = await LocationService2.init(
      //   talker: talker,
      ...
      // );
      // talker.critical('Geolocation Initialization Result: $geoInitResult');
